...
def newProduct():
    ...
    product = Product(product_title=form.product_name.data, product_description=form.product_description.data, Category=Category, product_price=form.product_price.data, category_category_id=form.category.data,
